...
<template>
  <Teleport to="body">
    <div v-if="settingsStore.showHelp" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" @click="close">
      <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl max-w-md w-full" @click.stop>
        <div class="p-8">
          <div class="flex justify-between items-center mb-8">
            <h2 class="text-2xl font-black dark:text-white">Settings</h2>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <span :class="settingsStore.soundEnabled ? 'text-green-500' : 'text-slate-400'">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl text-center">
                  <div class="text-2xl font-black text-blue-600">{{ statsStore.totalVisits }}</div>
                  <div class="text-xs text-slate-500 dark:text-slate-400">Visits</div>
                </div>
                <div class="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl text-center">
                  <div class="text-2xl font-black text-blue-600">{{ statsStore.formatTime() }}</div>
          ...
          <div class="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
            <p class="text-center text-sm text-slate-500 dark:text-slate-400">
              Portfolio v1.0.0 • Built with Vue 3 + Pinia
            </p>
          </div>
        </div>
      </div>
